...
python app.py --db /ruta/must_hear.db --lastfm-api-key TU_KEY
...
scp -i tu-key.pem must_hear.db ubuntu@<IP>:/home/ubuntu/escuchowsky/
```
...
ExecStart=/home/ubuntu/escuchowsky/venv/bin/gunicorn -w 2 -b 127.0.0.1:5000 "app:app" --preload -- --db /home/ubuntu/escuchowsky/must_hear.db
Restart=always
